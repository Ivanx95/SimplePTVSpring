 ...
 * <p>
 * {@link JavaFxView} is a stripped down version of <a href=
 ...
 *
 */
public abstract class JavaFxView implements ApplicationContextAware {
	 ...
	 */
	public JavaFxView() {
		LOGGER.debug("JavaFxView construction");
	...
	public JavaFxView(String value){
		this();
		this.subController=value;
	}
	/**
	...
	private FXMLView getFXMLAnnotation() {
		final Class<? extends JavaFxView> theClass = this.getClass();
	...
	public String toString() {
		return "JavaFxView [presenterProperty=" + presenterProperty + ", bundle=" + bundle + ", resource="
